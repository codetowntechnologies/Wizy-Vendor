...
class ChooseServiceActivity extends Component {
  constructor (props) {
    super(props)
  }
   state = {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.container}>
          <View style={styles.serviceBox}>
            <Text style={styles.name}>Select Service</Text>
            <View>
              <Picker
                selectedValue= {this.state.Service}
                onValueChange={this.updateService}>
            ...
            <View>
              <Picker
                ...
                <Picker.Item label='Jodhpur' value='Jodhpur' />
              </Picker>
            </View>
            <Text style={styles.name}>Vender Name</Text>
            ...
            <TextInput
              ...
              style={styles.input}
            />
            <Text style={styles.name}>Vender Address</Text>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.2}
              onPress={() => {
                console.log('user== ' + this.state.Service)

                if (this.state.Service === 'CAB Service') {
                 
                  this.props.navigation.navigate('CabBookingActivity')
                }
                 else if(this.state.Service==='Restaurants') 
                {
                  this.props.navigation.navigate('FoodMyBookingActivity')
                }
                else{
...
export default ChooseServiceActivity
