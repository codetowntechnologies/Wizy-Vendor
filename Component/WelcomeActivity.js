      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.headerView1}>
              <TouchableOpacity
                ...
                <Text style={styles.ServiceTitle}>UPComing Bookings</Text>
              </TouchableOpacity>
                  ...
                  <TouchableOpacity>
                    <View style={styles.box}>
                      <View style={styles.info}>
                        ...
                        <Text style={styles.name}>{item.Vender_Address}</Text>
                        <Text style={styles.name}>{item.Vender_Name}</Text>
