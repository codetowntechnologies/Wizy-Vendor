...
//     'pk.eyJ1IjoiaGFyc2hpdDEyMzQiLCJhIjoiY2tkdHVxY255MTVibDJ3bGliNnBoOGcydiJ9.MCyG5AWWR6SZgVd_KPBghQ',
//   );
  

class CabBookingActivity extends Component {
  constructor (props) {
    super(props)
    // this.state = {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.headerView1}>
              <TouchableOpacity
                ...
                <Text style={styles.ServiceTitle}>No Booking</Text>
              </TouchableOpacity>
...
export default CabBookingActivity;