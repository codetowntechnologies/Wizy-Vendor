...
class UpdateOderTab extends Component {
  constructor (props) {
    super(props)
    this.state = {
      data: [
         ...
         <View style={styles.container}>
          ...
          <View style={styles.container}>
                    ...
                    <View style={styles.box}>
                      ...
                      <View style={{flex:.5}}>
                        ...
                        <TouchableOpacity
                                    ...
                                    activeOpacity={.20}
                                  >
                                    <Text style={styles.buttonWhiteTextStyle}>{item.Button}</Text>
            ...
            <TouchableOpacity
                                    ...
                                    activeOpacity={.20}
                                    onPress={() => {this.props.navigation.navigate('AddItemActivity')}}>
                                    <Text style={styles.buttonWhiteTextStyle}>Add Item</Text>
